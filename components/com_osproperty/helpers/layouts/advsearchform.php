				...
				<fieldset>
					<div class="<?php echo $rowFluidClass; ?>">
						...
						<div class="<?php echo $span4Class; ?> searchfields">
							...
							<div class="clearfix"></div>
							<input type="text" class="input-large" value="<?php echo htmlspecialchars($lists['keyword_value'])?>" name="keyword"/>
						</div>
						<?php $increase_div++;?>
						<?php
						if($increase_div == 3)
				...
				<fieldset>
					...
					<div class="<?php echo $rowFluidClass; ?>">
						...
						<div class="<?php echo $span4Class; ?> searchfields">
							...
							<div class="clearfix"></div>
							<input type="text" class="input-medium" value="<?php echo htmlspecialchars($lists['address_value']);?>" name="address" />
						</div>
						<?php
						...
						<div class="<?php echo $bootstrapHelper->getClassMapping('span8'); ?>">
							...
							<div class="clearfix"></div>
							<input type="text" class="input-small" value="<?php echo $lists['postcode'];?>" id="postcode" name="postcode" placeholder="<?php echo JText::_('OS_POSTCODE');?>" />
							<?php 
