	...
	<div class="<?php echo $span12Class; ?>">
		...
		?>
			...
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="name" value="<?php echo $name?>" size="20" class="input-large" placeholder="<?php echo JText::_('OS_AGENT_NAME')?>" />
				</div>
			</div>
            <?php
			...
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="password" name="password" id="password" size="20" class="input-large"/>
				</div>
			</div>
			...
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="password" name="password2" id="password2" size="20" class="input-large"/>
				</div>
			</div>
		<?php
		}
...
<div class="<?php echo $rowFluidClass; ?>" id="agentprofilepage">
    <div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<div class="<?php echo $controlGroupClass; ?>">
			<div class="<?php echo $controlsClass; ?>">
				<?php echo OSPHelper::loadAgentTypeDropdown(0,'input-large','onChange="javascript:updateCompanyDropdown()"');?>
			</div>
		</div>
		<?php
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="phone" value="<?php echo $post['phone']; ?>" id="phone" size="20" class="input-large" placeholder="<?php echo JText::_('OS_PHONE')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="mobile" id="mobile" value="<?php echo $post['mobile']; ?>" size="20" class="input-large" placeholder="<?php echo JText::_('OS_MOBILE')?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="fax" id="fax" size="20" value="<?php echo $post['fax']; ?>" class="input-large" placeholder="<?php echo JText::_('OS_FAX')?>" />
				</div>
			</div>
		<?php
		}
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="address" id="address" size="20" value="<?php echo $post['address']; ?>" class="input-large" placeholder="<?php echo JText::_('OS_ADDRESS')?>" />
				</div>
			</div>
		<?php
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				<label class="<?php echo $controlLabelClass; ?>"><?php echo JText::_('OS_PHOTO')?></label>
				<div class="<?php echo $controlsClass; ?>">
    ...
    <div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
        ...
        if($configClass['show_agent_twitter'] == 1){
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <div class="<?php echo $controlsClass; ?>">
                    <input type="text" name="aim" id="aim" size="20" value="<?php echo $post['aim']; ?>" class="input-medium" placeholder="<?php echo JText::_('Twitter')?>" />
                </div>
            </div>
            <?php
        }
        if($configClass['show_agent_linkin'] == 1){
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <div class="<?php echo $controlsClass; ?>">
                    <input type="text" name="yahoo" id="yahoo" size="20" value="<?php echo $post['yahoo']; ?>" class="input-medium" placeholder="<?php echo JText::_('Linkin')?>" />
                </div>
            </div>
            <?php
        }
        if($configClass['show_license'] == 1){
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <div class="<?php echo $controlsClass; ?>">
                    <input type="text" name="license" id="license" size="20" value="<?php echo $post['license']; ?>" class="input-medium" placeholder="<?php echo JText::_('OS_LICENSE')?>" />
                </div>
            </div>
            <?php
        }
...
<div class="<?php echo $rowFluidClass; ?>">
    ...
    <?php
        if($configClass['captcha_agent_register'] == 1)
        {
            ...
            ?>
            <div class="<?php echo $controlGroupClass; ?> center">
                <table class="width100pc">
                    <tr>
                        <td class="center">
                            <span class="grey_small lineheight16" ><?php echo JText::_('OS_PLEASE_INSERT_THE_SYMBOL_FROM_THE_INAGE_TO_FIELD_BELOW')?></span>
                            <div class="clearfix"></div>
                            <img src="<?php echo JURI::root()?>index.php?option=com_osproperty&no_html=1&task=property_captcha&ResultStr=<?php echo $ResultStr?>" id="captchasecurityimage" />
                            <input type="text" id="comment_security_code" name="comment_security_code" maxlength="5"/>
                        </td>
                    </tr>
                </table>
                <div class="clear"></div>
