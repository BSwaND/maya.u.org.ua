...
<div class="<?php echo $rowFluidClass; ?>">
	<div class="<?php echo $span12Class; ?>">
        ...
        <div class="<?php echo $rowFluidClass?>" id="companyprofilefields">
            <div class="<?php echo $span6Class?>">
                ...
                if($user->id > 0){
                    ?>
                    <div class="<?php echo $controlGroupClass; ?>">
                        <input type="text" name="email" id="email" placeholder="<?php echo JText::_('OS_EMAIL')?>" class="input-large" value="<?php echo $email; ?>" />
                    </div>
                <?php } ?>
                <div class="<?php echo $controlGroupClass; ?>">
                ...
                <div class="<?php echo $controlGroupClass; ?>">
                    <input type="text" name="postcode" id="postcode" placeholder="<?php echo JText::_('OS_POSTCODE')?>" class="input-large" value="<?php echo $post['postcode']; ?>" />
                </div>
                <?php
                ...
                if(OSPHelper::userOneState()){
                    ...
                    ?>
                    <div class="<?php echo $controlGroupClass; ?>" id="country_state">
                        <?php
                        echo $lists['state'];
                        ?>
                    </div>
                <?php } ?>
                <div class="<?php echo $controlGroupClass; ?>" id="city_div">
                    <?php
                    echo $lists['city'];
                    ?>
                </div>
            ...
            <div class="<?php echo $span6Class?>">
                ...
                <div class="<?php echo $controlGroupClass; ?>">
                    <input type="text" name="phone" id="phone" placeholder="<?php echo JText::_('OS_PHONE')?>" class="input-large" value="<?php echo $post['phone']; ?>"/>
                </div>
                <div class="<?php echo $controlGroupClass; ?>">
                    <input type="text" name="fax" id="fax" placeholder="<?php echo JText::_('OS_FAX')?>" class="input-large" value="<?php echo $post['fax']; ?>"/>
                </div>
                <div class="<?php echo $controlGroupClass; ?>">
		...
		?>
		<div class="<?php echo $controlGroupClass; ?>">
			<label class="<?php echo $controlLabelClass; ?>"><?php echo JText::_('OS_SECURITY_CODE')?></label>
			<div class="<?php echo $controlsClass; ?>">
				<table>
					<tr>
						<td>
							...
							<input type="text" id="security_code" name="security_code" maxlength="5" class="input-mini"/>
						</td>
					</tr>
				</table>
				<div class="clear"></div>
