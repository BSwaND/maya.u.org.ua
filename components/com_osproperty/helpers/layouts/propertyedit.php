				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('row'); ?>" id="general-page">
					<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
						...
						if (JFactory::getUser()->authorise('frontendmanage', 'com_osproperty')) {
							...
							//if(($extend == 1) && (($configClass['active_payment'] == 1) and ($configClass['integrate_membership'] == 0) and ($show_payment_tab == 1))){
								//echo JHtml::_('bootstrap.startTabSet', 'propertyinformation', array('active' => 'addpropertypanel6'));
							//}else{
								echo JHtml::_('bootstrap.startTabSet', 'propertyinformation', array('active' => 'addpropertypanel1'));
							//}
						}
                                    ...
                                    <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid');?>">
                                        ...
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('span6');?>">
                                            ...
                                            <div id="pricediv" style="display:<?php echo $display;?>;">
												...
												<input type="text" name="price" id="price" value="<?php echo $row->price?>" class="input-small inlinedisplay" placeholder="0.00" />
                                                    <?php
                                    ...
                                    <div class="<?php echo $bootstrapHelper->getClassMapping('span6');?>">
                                        ...
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                            ...
                                            <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>" id="address_controls">
                                                ...
                                                <input type="text" name="postcode" id="postcode" value="<?php echo htmlspecialchars($row->postcode);?>" class="input-mini" placeholder="<?php echo JText::_('OS_POSTCODE');?>" />
                                                <?php
                                                if($configClass['address_required']){
                                                ?>
                                                    <?php
                                        ...
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                            ...
                                            <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>" id="coordinates_controls">
                                                <input class="input-small" type="text" name="lat_add" id="lat_add" value="<?php echo htmlspecialchars($row->lat_add);?>" size="30" placeholder="<?php echo JText::_('OS_LATTITUDE');?>" />
                                                &nbsp;
                                                <input class="input-small" type="text" name="long_add" id="long_add" value="<?php echo htmlspecialchars($row->long_add);?>" size="30" placeholder="<?php echo JText::_('OS_LONGTITUDE');?>" />
                                            </div>
                                        </div>
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>" id="coordinates_controls1">
                                            ...
                                            if($configClass['map_type'] == 0)
                                            {
                                                ...
                                                ?>
                                                <div id="map" class="width100pc border1" style="height: <?php echo $configClass['property_map_height']?>px;"></div>
                                                <BR />
                                                <div>
                                                    <strong><?php echo JText::_('OS_ENTER_ADDRESS_TO_CHECK_LATTITUDE_AND_LONGTITUDE')?></strong>
                                                    <input type="text" name="add" id="add" value="" size="20" class="input-large" />
								...
								<fieldset id="otherinformation" class="fieldsetpropertydetails">
									...
									<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
										...
										<div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
											...
											?>
											<span id="pro_pdf_filediv">
											<input type="file" name="panorama" id="panorama" size="40" class="input-large" onchange="javacript:check_file('panorama');" />
											<div class="clearfix"></div>
											</span>
										</div>
									</div>
													...
													<tr>
														...
														<td width="75%">
															<div id="div_nei_<?php echo $neighborhood->id?>" style="display:<?php echo $display?>;">
																<input type="text" name="mins_nei_<?php echo $neighborhood->id?>" class="width40 input-mini" value="<?php echo htmlspecialchars($neighbor_value->mins);?>" /> <?php echo JText::_('OS_MINS')?> <?php echo JText::_('OS_BY')?>
																&nbsp;&nbsp;&nbsp;
