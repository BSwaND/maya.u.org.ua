    ...
    <div class="<?php echo $bootstrapHelper->getClassMapping('span4'); ?>">
        <h1 class="componentheading agent_title">
            ...
            if($configClass['enable_report'] == 1)
            {
                ...
                ?>
                &nbsp;
                <a href="<?php echo JURI::root()?>index.php?option=com_osproperty&tmpl=component&task=property_reportForm&item_type=1&id=<?php echo $agent->id?>" class="osmodal reportlink" rel="{handler: 'iframe', size: {x: 350, y: 600}}" title="<?php echo JText::_('OS_REPORT_COMPANY');?>">
