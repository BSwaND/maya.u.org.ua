 ...
 *
 * @copyright  Copyright (C) 2015 - 2018 Ossolution Team. All rights reserved.
...
class OSPPaymentOmnipay extends OmnipayPayment
{
	...
	protected function beforeRequestSend($request, $row, $data)
	{
		...
		$request->setNotifyUrl($siteUrl . 'index.php?option=com_osproperty&task=payment_confirm&payment_method=' . $this->name . '&notify=1&Itemid=' . $Itemid);
