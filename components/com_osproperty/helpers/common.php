...
class HelperOspropertyCommon{
	...
	public static function loadCity($option,$state_id,$city_id,$class="input-medium"){
		global $bootstrapHelper, $jinput, $mainframe,$configClass,$languages;
		$db = JFactory::getDBO();
		$lgs = OSPHelper::getLanguages();
		$translatable = JLanguageMultilang::isEnabled() && count($lgs);
		$suffix = "";
	 ...
	 * @return unknown
	 */
	static function makeStateListAddProperty($req_country_id,$req_state_id,$name,$onChange,$firstOption,$style = 'class="input-medium"'){
		global $bootstrapHelper, $jinput, $configClass,$languages;
		$db = JFactory::getDbo();
		$lgs = OSPHelper::getLanguages();
		$translatable = JLanguageMultilang::isEnabled() && count($lgs);
	 ...
	 * @return unknown
	 */
	static function loadCityAddProperty($option,$state_id,$city_id,$class="input-medium"){
	...
	static public function getCompanyId($company_id = 0){
		global $bootstrapHelper, $jinput, $mainframe;
			...
			<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
					<div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
						<input type="text" id="comment_author" name="comment_author<?php echo date("j",time());?>" maxlength="50" class="input-large" value="<?php echo $user->name; ?>" placeholder="<?php echo JText::_('OS_YOUR_NAME');?>"/>
					</div>
				</div>

				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
					<div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
						<input type="text" id="comment_email" name="comment_email<?php echo date("j",time());?>" maxlength="50" class="input-large" value="<?php echo $user->email; ?>" placeholder="<?php echo JText::_('OS_EMAIL');?>"/>
					</div>
				</div>
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
					<div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
						<textarea class="text" id="message" rows="2" cols="50" class="input-large" name="message"><?php printf(JText::_('OS_PREDEFINED_CONTACT_MESSAGE'), $name, $site_name);?></textarea>
					</div>
				</div>
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
	...
	/**
    * This function is used to get Subscribed plans of user
    * @return array|mixed
    **/
    ...
    **/
	 ...
	 * @param unknown_type $type
	 */
	function discountSubscription($sub_id,$deduct = 1){
		$db = JFactory::getDbo();
        if(self::isAgent()) {
            $agent_id = self::getAgentID();
	...
	*/
	...
	static function generateLocatorForm($lists, $type_id){
		...
		<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> locatorpage margintop10">
			<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
                <div class="navbar">
                    <div class="navbar-inner">
                        <ul class="nav">
                            ...
                            <li class="divider-vertical  <?php echo $bootstrapHelper->getClassMapping('hidden-phone'); ?>"></li>
							<?php } ?>
							<li class="dropdown <?php echo $bootstrapHelper->getClassMapping('hidden-phone'); ?>">
		...
		<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> nodisplay" id="locatormoredetails">
			...
			<div class="<?php echo $bootstrapHelper->getClassMapping('span4'); ?>">
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
					...
					<div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
						<input type="text" class="input-medium" name="keyword" id="keyword" value="<?php echo htmlspecialchars($lists['keyword'])?>" placeholder="<?php echo JText::_('OS_KEYWORD_FITLER_PLACEHOLDER');?>" />
					</div>
				</div>
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
		...
		<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> locatorpagevertical margintop10">
			<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> alignleft">
				...
				if($configClass['use_bedrooms'] == 1){
					?>
					<BR />
					<strong><?php echo JText::_('OS_BEDS')?></strong>
					<?php echo $lists['nbed'];?>
				<?php } ?>
				<?php
				if($configClass['use_bedrooms'] == 1){
					?>
					<BR />
					<strong><?php echo JText::_('OS_BATHS')?></strong>
					<?php echo $lists['nbath'];?>
				<?php } ?>
				<BR />
    ...
    public static function sharingForm($row,$itemid){
        ...
        <div class="leadFormWrap">
            <form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_submittellfriend&Itemid=<?php echo $itemid?>" name="tellfriend_form" id="tellfriend_form" class="form-horizontal">
                ...
                <input class="btn btn-info" type="button" name="finish" value="<?php echo JText::_('OS_SEND');?>" onclick="javascript:submitForm('tellfriend_form');"/>
        ...
        <div class="leadFormWrap">
            <form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_requestmoredetails&Itemid=<?php echo $itemid?>" name="requestdetails_form" id="requestdetails_form" class="form-horizontal">
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?> <?php echo $div_requestcheckin;?>" id="requestcheckin">
                    ...
                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                        <?php echo JHTML::_('calendar','','requestmoredetailscheckin','requestmoredetailscheckin',"%Y-%m-%d",array('class'=>'input-medium'));?>
                    </div>
                </div>
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?> <?php echo $div_requestcheckout;?>" id="requestcheckout">
                    ...
                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                        <?php echo JHTML::_('calendar','','requestmoredetailscheckout','requestmoredetailscheckout',"%Y-%m-%d",array('class'=>'input-medium'));?>
                    </div>
                </div>
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?> <?php echo $div_requestguests;?>" id="requestguests">
                    ...
                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                        <input class="input-large" type="text" id="nguest" name="nguest" placeholder="<?php echo JText::_('OS_NGUEST')?>"/>
                    </div>
                </div>
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>" id="requestmessagediv">
					...
					?>
                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                        <textarea class="input-large" id="requestmessage" name="requestmessage" rows="3" cols="60"><?php echo $message;?> <?php echo ($row->ref != "")? $row->ref.", ":""?><?php echo $row->pro_name?></textarea>
                    </div>
                </div>
                <?php
                $passcaptcha        = 0;
        ...
        <div class="leadFormWrap">
            <form method="POST" action="<?php echo JURI::root()?>index.php?option=com_osproperty&task=property_requestmoredetails&Itemid=<?php echo $itemid?>" name="requestdetails_form" id="requestdetails_form">
				...
				<span id="requestcheckin" class="<?php echo $div_requestcheckin;?>">
					<?php echo JHTML::_('calendar','','requestmoredetailscheckin','requestmoredetailscheckin',"%Y-%m-%d",array('class'=>'input-small','placeholder'=>JText::_('OS_CHECKIN')));?>
				</span>
				<span id="requestcheckout" class="<?php echo $div_requestcheckout;?>">
					<?php echo JHTML::_('calendar','','requestmoredetailscheckout','requestmoredetailscheckout',"%Y-%m-%d",array('class'=>'input-small','placeholder'=>JText::_('OS_CHECKOUT')));?>
                </span>
				<span id="requestguests" class="<?php echo $div_requestguests;?>">
                     <input class="input-medium" type="text" id="nguest" name="nguest" placeholder="<?php echo JText::_('OS_NGUEST')?>"/>
                </span>
									...
									?>
										<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
											<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
												...
												<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
													<?php
													echo JHTML::_('select.genericlist',$rateOption,'rate'.$i ,'class="input-mini"','value','text');
													?>
												</div>
											</div>
										</div>
