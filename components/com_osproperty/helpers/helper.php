...
class OSPHelper
{
     ...
     */
    public static function loadGoogleJS($suffix = false){
		global $configClass;
        static $loadGoogleJs;
    ...
    public static function showPropertyPhoto($image, $image_folder, $pid, $style, $class, $js, $loadlazy = 1,$alt = '')
    {
		...
		if(($configClass['load_lazy']) && ($loadlazy == 1)){
			$photourl = JUri::root(true)."/media/com_osproperty/assets/images/loader.gif";
		}else{
			$photourl = Juri::root(true).'/images/osproperty/properties/'.$pid . '/' . $image_folder . $image;	
		}
        if ($image != "") {
...
//		$query = 'SELECT *' .
    ...
    public static function showLocationAboveGoogle($address){
        ...
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?> margintop10">
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_SCHOOLS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_SCHOOLS');?> </a>		</div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_RESTAURANTS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_RESTAURANTS');?> </a>		</div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_DOCTORS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_DOCTORS');?> </a>		</div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_HOSPITALS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_HOSPITALS');?> </a>		</div>
        </div>
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_RAILWAY');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_RAILWAY');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_AIRPORTS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_AIRPORTS');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_SUPER_MARKET');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_SUPER_MARKET');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_THEATRE');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_THEATRE');?> </a>
            </div>
        </div>
        <div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_UNIVERSITIES');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_UNIVERSITIES');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_PARKS');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_PARKS');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_KINDERGARTEN');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_KINDERGARTEN');?> </a>
            </div>
            <div class="<?php echo $bootstrapHelper->getClassMapping('span3'); ?> marginleft10">
                <i class="osicon-search"></i> <a href="https://local.google.com/local?f=l&amp;hl=<?php echo $activate_language;?>&amp;q=category:+<?php echo JText::_('OS_SHOPPING_MALL');?>&amp;om=1&amp;near=<?php echo $address;?>" class="category" rel="nofollow" target="_blank"><?php echo JText::_('OS_SHOPPING_MALL');?> </a>
            </div>
        </div>
        <?php
    }
    ...
    public static function registration($data,$usertype = 0)
    {
        ...
        if ($useractivation == 2) 
		{
			...
			$data['activate'] = string_replace("/administrator","",$data['activate']);
	...
	static function redirect($url,$msg = ''){
    ...
    public function getCompanyName($agent_id)
    {
        $db = JFactory::getDbo();
