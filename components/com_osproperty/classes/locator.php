...
class OspropertyLocator{
	...
	static function display($option,$task){
		...
		$document->addScript(JURI::root()."media/com_osproperty/assets/js/lib.js","text/javascript",true);
		switch ($task){
	...
	static function locatorSearch($option){
		...
		$lists['type'] = JHTML::_('select.genericlist',$typeArr,'property_type','class="input-large chosen"','value','text',$property_type);
		...
		$lists['radius'] = JHtml::_('select.genericlist',$radiusArr,'radius_search','class="input-medium  search-query marginbottom20"', 'value', 'text',$radius_search);
