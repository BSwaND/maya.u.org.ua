			...
			<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> noleftmargin noleftpadding">
				...
				?>
					<div class="tab-pane" id="panel1">
						<form method="POST" action="<?php echo JRoute::_('index.php?option=com_osproperty&task=agent_layout&Itemid='.$jinput->getInt('Itemid',0))?>">
							<?php
		...
		<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>" id="editprofile">
			<div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?>">
				...
				<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
					...
					<?php
					if((count($lists['mostview']) > 0) || (count($lists['mostrate']) > 0))
					{
                                        ...
                                        <div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?> agentprofilebox">
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="phone" id="phone" size="30" value="<?php echo htmlspecialchars($agent->phone);?>" class="input-large" placeholder="<?php echo JText::_('OS_PHONE')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="mobile" id="mobile" size="30" value="<?php echo htmlspecialchars($agent->mobile);?>" class="input-large" placeholder="<?php echo JText::_('OS_MOBILE')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="fax" id="fax" size="30" value="<?php echo htmlspecialchars($agent->fax);?>" class="input-large" placeholder="<?php echo JText::_('OS_FAX')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="skype" id="skype" size="30" value="<?php echo htmlspecialchars($agent->skype);?>" class="input-large" placeholder="<?php echo JText::_('Skype')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="yahoo" id="yahoo" size="30" value="<?php echo htmlspecialchars($agent->yahoo);?>" class="input-large" placeholder="<?php echo JText::_('OS_LINKEDIN')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="gtalk" id="gtalk" size="30" value="<?php echo htmlspecialchars($agent->gtalk);?>" class="input-large" placeholder="<?php echo JText::_('Google Plus')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="msn" id="msn" size="30" value="<?php echo htmlspecialchars($agent->msn);?>" class="input-large" placeholder="<?php echo JText::_('Line messasges')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="facebook" id="facebook" size="30" value="<?php echo htmlspecialchars($agent->facebook);?>" class="input-large" placeholder="<?php echo JText::_('Facebook')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="aim" id="aim" size="30" value="<?php echo htmlspecialchars($agent->aim);?>" class="input-large" placeholder="<?php echo JText::_('Twitter')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div class="<?php echo $bootstrapHelper->getClassMapping('control-group'); ?>">
                                                    ...
                                                    <div class="<?php echo $bootstrapHelper->getClassMapping('controls'); ?>">
                                                        <input type="text" name="license" id="license" size="30" value="<?php echo htmlspecialchars($agent->license);?>" class="input-large" placeholder="<?php echo JText::_('OS_LICENSE')?>"/>
                                                    </div>
                                                </div>
                                            <?php
                                            }
