            ...
            <div class="<?php echo $bootstrapHelper->getClassMapping('span12'); ?> sharebox">
                ...
                <ul class="pf-sharebar-others">
                    ...
                    if($row->panorama != "")
                    {
                        ?>
                        <li>
                            <a rel="nofollow" rel="{handler: 'iframe', size: {x: 650, y: 420}}" href="<?php echo JURI::root()?>index.php?option=com_osproperty&tmpl=component&no_html=1&task=property_showpano&tmpl=component&id=<?php echo $row->id?>" title="<?php echo JText::_('OS_SHOW_PANORAMA_PICTURE')?>" class="osmodal">
                                <i class="osicon-picture"></i>
                                <?php
                                echo JTex::_('OS_PANORAMA');
                                ?>
                            </a>
                        </li>
                        <?php
                    ...
                    if($configClass['enable_report'] == 1)
                    {
                        ...
                        <li>
                            ...
                            <a class="osmodal" href="<?php echo JURI::root()?>index.php?option=com_osproperty&tmpl=component&item_type=0&task=property_reportForm&id=<?php echo $row->id?>" title="<?php echo JText::_('OS_REPORT_LISTING');?>">
