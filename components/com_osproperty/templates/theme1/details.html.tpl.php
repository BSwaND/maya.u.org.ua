			...
			<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
				...
				?>
					...
					<?php
						...
						?>
							<a href="<?php echo JURI::root()?>index.php?option=com_osproperty&tmpl=component&item_type=0&task=property_reportForm&id=<?php echo $row->id?>" class="osmodal reportlink" rel="{handler: 'iframe', size: {x: 350, y: 600}}" title="<?php echo JText::_('OS_REPORT_LISTING');?>">
				...
				<ul class="listingActions-list">
					...
					if($row->panorama != ""){
						...
						<li class="propertyinfoli">
							...
							<a rel="nofollow" href="<?php echo JUri::root(); ?>index.php?option=com_osproperty&task=property_showpano&id=<?php echo $row->id?>&tmpl=component" class="osmodal" rel="{handler: 'iframe', size: {x: 650, y: 420}}">
