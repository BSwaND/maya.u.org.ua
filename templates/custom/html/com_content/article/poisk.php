<?php
	...
	include_once(JPATH_BASE . '/templates/custom/html/com_content/article/_result.php');
?>
	...
	<div class="region-objects-block mb110">
		<div class="container">
			<div class="flex between align-center bottom-line mb30">
				<p class="title medium mb15">Поиск</p>
					...
					<div class="item">
						...
						<div class="item-wrapper">
							...
							<div class="btn-box flex between align-center">
								<a href="<?= JRoute::_(ContentHelperRoute::getCategoryRoute($itemProduct->catid)) .'/'. $itemProduct->alias  ?>" class="btn" target="_blank">Смотреть</a>
