	...
	<div class="ospsearch_div <?php echo $class;?>" id="basic_div<?php echo $random_id?>">
		<table width="100%">
			...
			<tr>
				...
				<?php } ?>
				<td class="mod_ossearch_right_col">
					<?php echo modOspropertySearchHelper::listCategories($category_ids,'',$inputbox_width_site); ?>
				</td>
			</tr>
			<?php
			}
        ...
        <div class="ospsearch_div <?php echo $class;?>" id="address_div<?php echo $random_id?>">
            <table  width="100%">
				...
				<tr>
					...
					<?php } ?>
					<td class="mod_ossearch_right_col">
						<input type="text" class="input-small" value="" id="postcode" name="postcode" placeholder="<?php echo JText::_('OS_POSTCODE');?>" />
						<?php 
						if($configClass['show_my_location'] == 1){
						?>
                        <?php echo JText::_('OS_OR');?>
                        <span class="se_geoloc_icon button" onclick="javascript:updateMyLocation();" id="se_geoloc_icon" title="<?php echo JText::_('OS_SEARCH_GEOLOC_TOOLTIP_INFO'); ?>" ></span>
						<?php } ?>
