				...
				<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->parent_id; ?>" item-id="<?php echo $row->id ?>" parents="<?php echo $parentsStr ?>" level="0">
					...
					<td align="center" style="text-align:center;">
						...
						if($row->category_image == ""){
							?>
							<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/noimage.png" style="height:50px;">
							<?php
						}else{
							?>
							<a href="<?php echo JURI::root()?>images/osproperty/category/<?php echo $row->category_image?>" target="_blank">
