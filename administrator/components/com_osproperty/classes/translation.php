...
class OspropertyTranslation{
	...
	function translation_list($option){
		...
		if(JFolder::exists(JPATH_ROOT.'/modules/mod_ospropertymortgage')){
			$options[] = JHtml::_('select.option','mod_ospropertymortgage','Module OS Property Mortgage');
		}
		...
		if(JFolder::exists(JPATH_ROOT.'/modules/mod_osmapsearch')){
			$options[] = JHtml::_('select.option','mod_osmapsearch','Map Search module');
		}
