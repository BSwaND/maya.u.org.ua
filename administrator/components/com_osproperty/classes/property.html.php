...
class HTML_OspropertyProperties{	
	...
	function listProperties($option,$rows,$pageNav,$lists){
		...
		<div class="row-fluid">
            <div class="span11 js-stools-container-bar">
			...
			<div class="span1 btn-group pull-right hidden-phone">
				<?php
        ...
        if(count($rows) > 0) {
            ...
            <table class="adminlist table table-striped">
                ...
                <tfoot>
                <tr>
                    <td width="100%" colspan="21" class="center">
                        <?php
                    ...
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td align="center" class="hidden-phone">
                            ...
                            <?php
                                ...
                                ?>
                                <img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/noimage.png" style="width:70px;" class="img-polaroid" />
                            <?php
                            }
                            ?>
                        </td>
                        ...
                        if ($tmpl != "component") {
                            ...
                            <td class="hidden-phone alignleft fontsmall">
								...
								<br/>
								<?php echo JText::_('OS_REPORT_ABUSE');?>: <?php echo $row->count_report;?>
                                <br/>
                                ...
                                <div class="btn-group">
                                    ...
                                    if ($row->isFeatured == 1) {
                                        ...
                                        <a class="btn btn-micro active hasTooltip colororange"
                                           ...
                                           title="<?php echo JText::_('OS_CHANGE_FEATURED_STATUS');?>">
                                    ...
                                    if ($row->approved == 1) {
                                        ...
                                        <a class="btn btn-micro active hasTooltip"
                                           ...
                                           title="Change approval status">
                                            <img style="width:14px;"
                                                 src="<?php echo JURI::root()?>media/com_osproperty/assets/images/tick.png">
                                        </a>
                                        <?php
                                        if ($configClass['general_use_expiration_management'] == 1) {
                                            ?>
                                        ...
                                        <a class="btn btn-micro active hasTooltip"
                                           ...
                                           title="Change approval status">
                                            <img style="width:14px;"
                                                 src="<?php echo JURI::root()?>media/com_osproperty/assets/images/publish_x.png">
                                        </a>
                                        <?php
                            ...
                            if (file_exists(JPATH_ROOT . DS . "components" . DS . "com_oscalendar" . DS . "oscalendar.php")) {
                                if ($configClass['integrate_oscalendar'] == 1) {
                                    ...
                                    ?>
                                    <td class="hidden-phone" align="center" class="data_td center">
                                        <a href="index.php?option=com_oscalendar&task=room_manage&pid=<?php echo $row->id;?>"
                                           ...
                                           title="<?php echo JText::_('OS_MANAGE_RENTAL_INFORMATION')?>">
                                            <img
                                                src="<?php echo JURI::root()?>media/com_osproperty/assets/images/room.png">
                                        </a>
	...
	function editProperty($option,$row,$lists,$amenities,$amenitylists,$groups,$neighborhoods,$translatable){
		...
		?>
		<?php echo JHtml::_('bootstrap.startTabSet', 'property', array('active' => 'basic-information-page')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'basic-information-page', JText::_('OS_BASIC_INFORMATION', true)); ?>
			<table width="100%">
				<tr>
														...
														<div id="pricediv" style="display:<?php echo $display;?>;">
															<table width="100%">
																...
																<tr>
																	<td class="key">
																		<?php
																		echo HelperOspropertyCommon::showLabel('price_text',JText::_("OS_PRICE_TEXT"),JText::_("OS_PRICE_TEXT_EXPLAIN"));
																		?>
																	</td>
																	<td>
																		<input type="text" class="input-large" name="price_text" value="<?php echo $row->price_text;?>" />
																	</td>
																</tr>
															</table>
														</div>
									...
									<div class="col width-100">
										<fieldset class="general">
											...
											<table  width="100%" class="admintable">
												<tr>
													<td class="key" width="20%">
														<?php echo HelperOspropertyCommon::showLabel('show_address',JText::_('OS_SHOW_ADDRESS'),JText::_('OS_SHOW_ADDRESS_EXPLAIN'));?>
													</td>
													<td width="80%">
														<div id="div_states">
															<?php
												...
												<tr>
													...
													<td width="80%">
														<input type="text" name="address" id="address" value="<?php echo htmlspecialchars($row->address);?>" size="50">
														<?php
												...
												<tr>
													...
													<td>
                                                        ...
                                                        {
                                                            include(JPATH_ROOT.DS."components".DS."com_osproperty".DS."helpers".DS."openstreetmap.lib.php");
				...
				<tr>
					...
					<td width="100%" colspan="2">
						<div class="col width-100">
						<fieldset class="general">
							<legend><?php echo JText::_( 'OS_DESCRIPTION' ); ?></legend>
							<table  width="100%" class="admintable">
								<tr>
									<td class="key" valign="top">
										<?php echo JText::_('OS_SHORT_DESCRIPTION')?>
									</td>
									<td width="80%">
										<textarea name="pro_small_desc" id="pro_small_desc" style="width:450px !important;" rows="5" class="input-large"><?php echo stripslashes($row->pro_small_desc)?></textarea>
										<?php
		...
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'details-page', JText::_('OS_DETAILS', true)); ?>
			<table width="100%">
			<tr>
                <td width="100%">
                    <div class="col width-100">
                    <fieldset class="general">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($row->pro_pdf_file != "")
                                    {
                                        ...
                                        ?>
                                        <a href="<?php echo $fileUrl;?>" target="_blank" title="<?php echo JText::_('OS_VIEW_DOCUMENT')?>"><?php echo $row->pro_pdf_file?></a>

                                        <BR />
                                        <input type="checkbox" name="remove_pdf" id="remove_pdf" onclick="javascript:changeValue('remove_pdf')" value="0"> <b><?php echo JText::_('OS_REMOVE_DOCUMENT');?></b>
                                        <BR />
                                        <?php
                                    }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($row->panorama != ""){
                                        ...
                                        <BR />
                                        <input type="checkbox" name="remove_panorama" id="remove_panorama" onclick="javascript:changeValue('remove_panorama')" value="0"> <b><?php echo JText::_('OS_REMOVE_DOCUMENT');?></b>
                                        <BR />
                                        <?php
                                    }
                                    ?>
                                    <input type="file" name="panorama" id="panorama" size="40" class="inputbox" onchange="javacript:check_file('panorama');"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        if($configClass['use_parking']== 1){
							if (version_compare(JVERSION, '4.0.0-dev', 'ge')){
								echo JHtml::_('bootstrap.addSlide', 'menu-pane3', JText::_('OS_PARKING'), 'parking_fields');
							}
							else
							{
                        ...
                        {
							if (version_compare(JVERSION, '4.0.0-dev', 'ge')){
								echo JHtml::_('bootstrap.addSlide', 'menu-pane3', JText::_('OS_PROPERTY_HISTORY_TAX'), 'history_and_tax');
							}
							else
							{
								echo JHtml::_('sliders.panel', JText::_('OS_PROPERTY_HISTORY_TAX'), 'history_and_tax');
							}
                            ?>
                            <table  width="100%" class="admintable">
                                <tr>
				...
				<tr>
					...
					//echo $pane->endPanel();
						...
						if (version_compare(JVERSION, '4.0.0-dev', 'ge'))
						{
							echo JHtml::_('bootstrap.startAccordion', 'extrafield-groups');	
						}
						else
						{
							echo JHtml::_('sliders.start', 'extrafield-groups');
						}
						...
						for($i=0;$i<count($groups);$i++){
							...
							if (version_compare(JVERSION, '4.0.0-dev', 'ge'))
							{
								echo JHtml::_('bootstrap.addSlide', 'extrafield-groups', $group->group_name, strtolower(str_replace(" ","",$group->group_name)));	
							}
							else
							{
							...
							if(count($fields) > 0){
								for($j=0;$j<count($fields);$j++){
									...
									?>
									<div class="span12 noleftmargin" id="extrafield_<?php echo $field->id?>" style="<?php echo $display;?>">
										<div class="span3 extrafield_label noleftmargin">
											<?php echo $field->field_label?>
										</div>
										<div class="span9 extrafield_input noleftmargin">
											<?php
		...
		if(count($amenities) > 0){
			echo JHtml::_('bootstrap.addTab', 'property', 'amenities-page', JText::_('OS_AMENITIES', true)); 
				$optionArr = array();
		...
		?>
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'opentime-page', JText::_('OS_PROPERTY_OPEN_HOUSE', true)); ?>
			<table width="100%">
				<tr>
					<!-- Other information -->
					<td width="100%">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'neighbor-page', JText::_('OS_NEIGHBOR', true)); ?>
			<table  width="100%" class="admintable">
				<?php
					...
					<tr>
						<td class="key" width="15%">
							<label for="nei_<?php echo $neighborhood->id?>">
								<strong><?php echo JText::_($neighborhood->neighborhood)?></strong>
							</label>
						</td>
						<td width="5%">
		...
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'photo-page', JText::_('OS_PHOTO', true)); ?>
			<div class="col width-100">
				<fieldset id="photos<?php echo $row->id; ?>">
					...
					<ul class="nav nav-pills">
						...
						<li><a href="#grab-file" data-toggle="tab"><?php echo JText::_('OS_GRAB_IMAGES'); ?></a></li>
						<?php } ?>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="photo-file">
							...
							if(count($row->photo) > 0){
								...
								<strong><?php echo Jtext::_('OS_CHECKALL');?></strong>
								<BR />
							...
							<div clas="row-fluid">
								<div class="span12">
									...
									<div id="grab_images_raw">
										...
										<input type="button" value="<?php echo JText::_('OS_GRAB_IMAGES');?>" class="btn" onClick="javascript:doGrabImage();"/>
										</span>
									</div>
								</div>
							</div>
		...
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'pulishing-page', JText::_('OS_PUBLISHING', true)); ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'meta-page', JText::_('OS_METADATA', true)); ?>
			<?php
			if ($translatable)
			{
				?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'property', 'note-page', JText::_('OS_NOTES', true)); ?>
		<table width="100%" class="admintable">
			<tr>
				<td class="key" valign="top" width="15%">
				...
				<td width="85%">
					<textarea name="note" id="note" cols="50" rows="5" class="inputbox" style="width:400px !important;height:150px !important;"><?php echo $row->note?></textarea>
				</td>
			</tr>
		</table>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
							...
							<div class="tab-pane<?php echo $i == 0 ? ' active' : ''; ?>" id="translation-page-<?php echo $sef; ?>">													
								<table width="100%" class="admintable backgroundwhite">
									...
									<tr>
										...
										<td>
											<input type="text" name="price_text_<?php echo $sef;?>" id="price_text_<?php echo $sef;?>" value="<?php echo $row->{'price_text_'.$sef}?>" size="50" class="input-large" />
										</td>
									</tr>
                                    <tr>
                                        <td class="key">
								...
								<table  width="100%" class="admintable">
									<tr>
										...
										<td>
											...
											if($row->agent->photo != ""){
												...
												?>
												<img style="width: 70px;" src="<?php echo JURI::root()?>media/com_osproperty/assets/images/user.png" class="border1" width="120">
												<?php
											}
											?>
										</td>
									...
									<tr>
										<td class="key" style="text-align:right;">
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/phone.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/mobile.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/fax.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/gtalk.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/skype.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/aim.png">
										</td>
										<td>
									...
									<tr>
										<td class="key" >
											<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/facebook.png">
										</td>
										<td>
			...
			<table  width="100%" class="backgroundlightgray border1">
				<tr>
					<td width="100%" class="padding5">
						...
						<BR><BR>
						<center>
							<input type="submit" class="btn btn-primary colorred fontbold" value="<?php echo JText::_('OS_BACKUP')?>" style="border:1px solid pink;">
						</center>
						<BR>
					</td>
				</tr>
				...
				<tr>
					<td width="100%" class="padding5">
						...
						<center>
							...
							<BR>
							<BR>
							<input type="submit" class="btn btn-primary colorred fontbold" value="<?php echo JText::_('OS_RESTORE')?>" style="border:1px solid pink;">
						</center>
						<BR>
					</td>
				</tr>
	...
	static public function showInstallationComplete(){
		global $mainframe;
		?>
		<div class="row-fluid">
			<div class="span12">
	...
	function htmlStatistic($lists)
    {
        JToolBarHelper::title(JText::_('OS_STATISTIC'),"generic");
        ...
        <div class="row-fluid">
            ...
            ?>
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_NEW_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
                        foreach($lists['newproperties'] as $item)
                        {
                            ?>
                            <li>
                                <a href="index.php?option=com_osproperty&task=properties_edit&id=<?php echo $item->id;?>" title="<?php echo Jtext::_('OS_EDIT_PROPERTY');?>">
            ...
            if(count($lists['modifiedproperties']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_JUST_MODIFIED_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
            ...
            if(count($lists['topview']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_MOST_VIEWED_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
            ...
            if(count($lists['noview']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_NO_VIEWED_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
        ...
        <div class="row-fluid statisticbox2">
            ...
            if(count($lists['newagents']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_NEW_AGENTS');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
                        foreach($lists['newagents'] as $item)
                        {
                            ?>
                            <li>
                                <a href="index.php?option=com_osproperty&task=agent_edit&cid[]=<?php echo $item->id;?>" title="<?php echo Jtext::_('OS_EDIT_AGENT');?>">
                                    <?php echo $item->name;?>
                                </a>
                            </li>
                            <?php
            ...
            if(count($lists['newcompanies']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_NEW_COMPANIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
                        foreach($lists['newcompanies'] as $item)
                        {
                            ?>
                            <li>
                                <a href="index.php?option=com_osproperty&task=companies_edit&cid[]=<?php echo $item->id;?>" title="<?php echo Jtext::_('OS_EDIT_COMPANY');?>">
            ...
            if(count($lists['agentnoproperties']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_AGENTS_WITHOUT_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
            ...
            if(count($lists['companynoproperties']) > 0)
            {
                ...
                <div class="span3 statisticbox">
                    <strong>
                        <?php echo JText::_('OS_COMPANIES_WITHOUT_PROPERTIES');?>
                    </strong>
                    <div class="clearfix"></div>
                    <ul>
                        <?php
