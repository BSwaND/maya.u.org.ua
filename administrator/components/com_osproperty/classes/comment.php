...
class OspropertyComment{
	...
	function comment_edit($option,$id){
		...
		$lists['rate1'] = JHTML::_('select.genericlist',$rateOption,'rate1','class="input-mini"','value','text',$row->rate1);
		$lists['rate2'] = JHTML::_('select.genericlist',$rateOption,'rate2','class="input-mini"','value','text',$row->rate2);
		$lists['rate3'] = JHTML::_('select.genericlist',$rateOption,'rate3','class="input-mini"','value','text',$row->rate3);
		$lists['rate4'] = JHTML::_('select.genericlist',$rateOption,'rate4','class="input-mini"','value','text',$row->rate4);
		...
		$lists['hours'] = JHtml::_('select.genericlist',$hourArr,'hour','class="input-mini"','value','text',$hour);

		$minArr = array();
		for($i=1;$i<=60;$i++){
			$minArr[] = JHtml::_('select.option',$i,$i);
		}
		$lists['min'] = JHtml::_('select.genericlist',$minArr,'min','class="input-mini"','value','text',$min);
	...
	function getPropertyInput($pro_id)
    {
        ...
        else
        {
            ...
            $field = JFormHelper::loadFieldType('Modal_Property');
