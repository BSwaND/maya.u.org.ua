			...
			<table  width="100%" class="admintable">
				<tr>
					<td class="key" width="20%">
						<span class="editlinktip hasTip" title="<?php echo JText::_( 'Show states/cities that have properties' );?>::<?php echo JText::_('Do you want to show states/cities that have properties available. If you turn this field on, OS Property will have slower loading'); ?>">
				...
				<tr>
					<td class="key" width="20%">
						<span class="editlinktip hasTip" title="<?php echo JText::_( 'Show My Location' );?>::<?php echo JText::_('Do you want to show My Location in search functions. In new updation, My Location function does not work on Chrome browser'); ?>">
			                <label for="configuration[show_my_location]">
			                    <?php echo JText::_( 'Show My Location' ).':'; ?>
			                </label>
						</span>
					</td>
					<td valign="top" width="80%">
				...
				<tr>
					<td class="key" nowrap="nowrap" valign="top">
						<span class="editlinktip hasTip" title="<?php echo JTextOs::_( 'Select property type' );?>::<?php echo JText::_('Please select Property types that will be shown in Search form, if you select specific Property types, those types will be shown as tabs above Search form'); ?>">
							<label for="configuration[category_layout]">
