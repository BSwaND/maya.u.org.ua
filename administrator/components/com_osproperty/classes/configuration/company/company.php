...
<fieldset>
	...
	<table width="100%" class="admintable">
		...
		<tr>
			<td class="key" nowrap="nowrap">
				<span class="editlinktip hasTip" title="<?php echo JText::_('If set to Yes, when you turn on registration integration, OS Property will display login box to allow users who has existing account can login before continuing with company registration process'); ?>">
					  <label for="checkbox_auto_approval_agent_registration">
						  <?php echo JText::_( 'Show Login box on Registration form' ).':'; ?>
					  </label>
				</span>
			</td>
			<td>
		...
		<tr>
			<td class="key" nowrap="nowrap">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Alow company admin to change Featured status' );?>::<?php echo JText::_('Do you allow Company admin to change Featured status of agent'); ?>">
					 <label for="checkbox_general_agent_listings">
						 <?php echo JText::_( 'Alow company admin to change Featured status' ).':'; ?>
					 </label>
				</span>
			</td>
			<td>
		...
		<tr>
			<td class="key" nowrap="nowrap">
				<span class="editlinktip hasTip" title="<?php echo JText::_('Do you want to use email as username, in that case, we can remove Username field in Registration form'); ?>">
					<label for="checkbox_property_show_rating">
						<?php echo JText::_( 'Use email as username' ).':'; ?>
					</label>
				</span>
			</td>
			<td>
		...
		<tr>
			<td class="key" nowrap="nowrap">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Registration completed link' );?>::<?php echo JText::_('Enter the link that user will be redirected after completing Registration progress. Leave it empty then OS Property will redirect user to Home page'); ?>">
					 <label for="checkbox_general_agent_listings">
						 <?php echo JText::_( 'Registration completed link' ).':'; ?>
					 </label>
				</span>
			</td>
			<td>
				<input type="text" name="configuration[company_redirect_link]" class="input-large" value="<?php echo $configs['company_redirect_link'];?>" />
			</td>
		</tr>
	</table>
</fieldset>