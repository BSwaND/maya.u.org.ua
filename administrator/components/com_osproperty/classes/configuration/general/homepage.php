        ...
        <td width="50%" valign="top">
            ...
            <fieldset>
                ...
                <table  width="100%" class="admintable">
                    ...
                    <tr>
                        <td class="key" nowrap="nowrap">
                            <span class="editlinktip hasTip" title="<?php echo JText::_( 'OS_SHOW_CAPTCHA_IN_REQUEST_MORE_DETAILS_FORM' );?>::<?php echo JText::_('OS_SHOW_CAPTCHA_IN_REQUEST_MORE_DETAILS_FORM_EXPLAIN'); ?>">
                                <label for="checkbox_property_mail_to_friends">
                                    <?php echo JText::_( 'OS_SHOW_CAPTCHA_IN_REQUEST_MORE_DETAILS_FORM' ).':'; ?>
                                </label>
                            </span>
                        </td>
                        <td>
                            <?php
                            OspropertyConfiguration::showCheckboxfield('captcha_in_request_more_details',$configs['captcha_in_request_more_details']);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="key" nowrap="nowrap">
                            <span class="editlinktip hasTip" title="<?php echo JText::_( 'OS_USE_GOOGLE_RECAPTCHA_IN_REQUEST_MORE_DETAILS' );?>::<?php echo JText::_('OS_USE_GOOGLE_RECAPTCHA_IN_REQUEST_MORE_DETAILS_EXPLAIN'); ?>">
                                <label for="checkbox_property_mail_to_friends">
                                    <?php echo JText::_( 'OS_USE_GOOGLE_RECAPTCHA_IN_REQUEST_MORE_DETAILS' ).':'; ?>
                                </label>
                            </span>
                        </td>
                        <td>
                            <?php
                            OspropertyConfiguration::showCheckboxfield('user_recaptcha_in_request_more_details',$configs['user_recaptcha_in_request_more_details']);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="key" nowrap="nowrap">
                            <span class="editlinktip hasTip" title="<?php echo JText::_( 'OS_TURN_ON_TELL_FRIEND_FORM' );?>::<?php echo JTextOs::_('MAIL_TO_FRIEND_EXPLAIN'); ?>">
                                <label for="checkbox_property_mail_to_friends">
                                    <?php echo JText::_( 'OS_TURN_ON_TELL_FRIEND_FORM' ).':'; ?>
                                </label>
                            </span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="key" nowrap="nowrap">
                            <span class="editlinktip hasTip" title="<?php echo JText::_( 'OS_SHOW_CAPTCHA_IN_TELL_FRIEND_FORM' );?>::<?php echo JText::_('OS_SHOW_CAPTCHA_IN_TELL_FRIEND_FORM_EXPLAIN'); ?>">
                                <label for="checkbox_property_mail_to_friends">
                                    <?php echo JText::_( 'OS_SHOW_CAPTCHA_IN_TELL_FRIEND_FORM' ).':'; ?>
                                </label>
                            </span>
                        </td>
                        <td>
                            <?php
                            OspropertyConfiguration::showCheckboxfield('captcha_in_tell_friend_form',$configs['captcha_in_tell_friend_form']);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="key" nowrap="nowrap">
                            <span class="editlinktip hasTip" title="<?php echo JText::_( 'OS_PASS_CAPTCHA_WITH_LOGGED_USER' );?>::<?php echo JText::_('OS_PASS_CAPTCHA_WITH_LOGGED_USER_EXPLAIN'); ?>">
                                <label for="checkbox_property_mail_to_friends">
                                    <?php echo JText::_( 'OS_PASS_CAPTCHA_WITH_LOGGED_USER' ).':'; ?>
                                </label>
                            </span>
                        </td>
                        <td>
                            <?php
                            OspropertyConfiguration::showCheckboxfield('pass_captcha_with_logged_user',$configs['pass_captcha_with_logged_user']);
                            ?>
                        </td>
                    </tr>
                    <tr>
