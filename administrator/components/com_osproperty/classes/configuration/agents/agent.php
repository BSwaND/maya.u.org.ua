	...
	<tr>
		...
		<td width="50%" valign="top">
			...
			<table width="100%" class="admintable">
				...
				<tr>
					<td class="key" nowrap="nowrap">
						<span class="editlinktip hasTip" title="<?php echo JText::_('If set to Yes, when you turn on registration integration, OS Property will display login box to allow users who has existing account can login before continuing with agent registration process'); ?>">
							  <label for="checkbox_auto_approval_agent_registration">
				...
				<tr>
					...
					<td>
						<input type="text" name="configuration[agent_redirect_link]" class="input-large" value="<?php echo $configs['agent_redirect_link'];?>" />
					</td>
				</tr>
			</table>
		</td>
		...
		<tr>
			...
			<td width="50%" valign="top">
				...
				<table width="100%" class="admintable">
                    ...
                    <tr>
                        <td class="key" nowrap="nowrap">
							<span class="editlinktip hasTip" title="<?php echo JText::_('OS_ONLY_SHOW_AGENTS_HAVE_PROPERTIES_EXPLAIN'); ?>">
								<label for="checkbox_property_show_rating">
									<?php echo JText::_( 'OS_ONLY_SHOW_AGENTS_HAVE_PROPERTIES' ).':'; ?>
								</label>
							</span>
                        </td>
                        <td>
