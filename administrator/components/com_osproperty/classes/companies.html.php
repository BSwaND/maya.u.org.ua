			...
			<tr>
				<td width="100%">
                    <DIV class="btn-wrapper input-append">
                        <input type="text" name="keyword" placeholder="<?php echo JText::_('OS_SEARCH');?>" value="<?php echo JFactory::getApplication()->input->getString('keyword','')?>" class="input-medium" />
				...
				<td width="38%" valign="top">
					<table  width="100%" class="admintable" style="background-color:white;">
						<tr>
							...
							<td width="70%">
								<input type="text" name="address" id="address" class="input-medium" value="<?php echo $row->address?>" />
							</td>
						</tr>
						<?php
