		...
		<form method="POST" action="index.php" name="adminForm" id="adminForm">
			<table  width="100%" class="admintable" style="background-color:white;">
				<tr>
					...
					<td>
						<input type="text" name="title" id="title" size="40" value="<?php echo $row->title; ?>" class="input-xxlarge" />
					</td>
				</tr>
				<tr>
					<td class="key">
						<?php echo JText::_('OS_RATE_FOR'); ?>&nbsp;<?php echo JText::_('OS_RATE_OPTION1'); ?>
					</td>
					<td>
						<?php
						echo $lists['rate1'];
				...
				<tr>
					<td class="key">
						<?php echo JText::_('OS_RATE_FOR'); ?>&nbsp;<?php echo JText::_('OS_RATE_OPTION2'); ?>
					</td>
					<td>
						<?php
						echo $lists['rate2'];
				...
				<tr>
					<td class="key">
						<?php echo JText::_('OS_RATE_FOR'); ?>&nbsp;<?php echo JText::_('OS_RATE_OPTION3'); ?>
					</td>
					<td>
						<?php
						echo $lists['rate3'];
				...
				<tr>
					<td class="key">
						<?php echo JText::_('OS_RATE_FOR'); ?>&nbsp;<?php echo JText::_('OS_RATE_OPTION4'); ?>
					</td>
					<td>
						<?php
						echo $lists['rate4'];
				...
				<tr>
					<td class="key">
						<?php echo JText::_('OS_TOTAL_RATE'); ?>
					</td>
					<td>
						<strong>
							<?php
				...
				<tr>
					...
					<td class="created_date_calendar">
						<?php
						echo JHtml::_('calendar',$row->created_on,'created_on','created_on','%Y-%m-%d',array( 'class' => 'input-small'));
						echo $lists['hours'];
						echo ":";
						echo $lists['min'];
						?>
