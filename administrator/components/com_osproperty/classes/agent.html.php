				...
				<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->company_id; ?>" item-id="<?php echo $row->id ?>" parents="<?php echo $parentsStr ?>" level="0">
					...
					<td align="center" class="center">
						...
						<?php
							...
							?>
							<img src="<?php echo JURI::root()?>media/com_osproperty/assets/images/noimage.jpg" style="height:55px" />
							<?php
						}
						?>
					</td>
					...
					?>
						<td align="center" class="center">
							<div class="btn-group">
								...
								if($row->featured == 1){
									?>
									<a class="btn btn-micro active hasTooltip colororange" href="index.php?option=com_osproperty&task=agent_changeunfeatured&cid[]=<?php echo $row->id?>&limitstart=<?php echo $pageNav->limitstart?>&limit=<?php echo $pageNav->limit?>" title="<?php echo JText::_('OS_CHANGE_FEATURED_STATUS');?>">
										<i class="osicon-star"></i>
									</a>
									<?php
								}else{
									?>
									<a class="btn btn-micro active hasTooltip colorblack" href="index.php?option=com_osproperty&task=agent_changefeatured&cid[]=<?php echo $row->id?>&v=1&limitstart=<?php echo $pageNav->limitstart?>&limit=<?php echo $pageNav->limit?>" title="<?php echo JText::_('OS_CHANGE_FEATURED_STATUS');?>">
										<i class="osicon-star"></i>
									</a>
									<?php
								}
				...
				<tr>
							...
							<table width="100%" >
                                ...
                                <tr>
                                    <td width="100%" id="joomlauser" colspan="2" style="padding:10px; border:1px solid #EEE; margin:10px;">
                                        <strong>
                                            <?php echo JText::_('OS_JOOMLA_USER');?>
                                        </strong>
                                        <BR />
                                        <input type="radio" name="existing_user" id="existing_user1" value="1" checked onclick="javascript:showDiv('existing_user_div','new_user_div');"/>&nbsp; <label for="existing_user1"><?php echo JText::_('OS_EXISTING_USER');?></label>
                                        <BR />
                                        <input type="radio" name="existing_user" id="existing_user0" value="0" onclick="javascript:showDiv('new_user_div','existing_user_div');"/>&nbsp; <label for="existing_user0"><?php echo JText::_('OS_NEW_JOOMLA_USER');?></label>
                                        <BR />
                                        <div id="existing_user_div" style="width: 100%;">
                                            <strong><?php echo JText::_('OS_SELECT_JOOMLA_USER')?></strong>
                                            <?php
                                            echo OspropertyAgent::getUserInput($row->user_id,$row->id);
                                            ?>
                                        </div>
                                        <div id="new_user_div" style="width: 100%;display:none;">
                                            <strong><?php echo JText::_('OS_CREATE_NEW_USER');?></strong>
                                            <table width="100%">
                                                <tr>
					...
					<td width="35%" valign="top">
						...
						<fieldset class="fieldset_web">
							...
							<table width="100%">
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/phone.jpg"></td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/mobile.jpg"></td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/fax.jpg"></td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/skype.jpg"> </td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/msn.jpg"> </td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/linkin.jpg"> </td>
									<td width="70%"><input type="text" name="yahoo" id="yahoo" size="40" maxlength="100" value="<?php echo $row->yahoo;?>" class="input-medium" placeholder="<?php echo Jtext::_('OS_LINKEDIN');?>"/></td>
								</tr>
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/gplus.jpg"> </td>
									<td width="70%"><input type="text" name="gtalk" id="gtalk" size="40" maxlength="100" value="<?php echo $row->gtalk?>" class="input-medium" placeholder="<?php echo Jtext::_('Google Plus');?>"/></td>
								</tr>
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/facebook.jpg"> </td>
								...
								<tr>
									<td class="key" class="center"><img alt="" src="<?php echo JURI::root(true)?>/media/com_osproperty/assets/images/twitter.jpg"> </td>
									<td width="70%"><input type="text" name="aim" id="aim" size="40" maxlength="100" value="<?php echo $row->aim?>" class="input-medium" placeholder="<?php echo Jtext::_('Twitter');?>" /></td>
								</tr>
							</table>
						</fieldset>
					</td>
