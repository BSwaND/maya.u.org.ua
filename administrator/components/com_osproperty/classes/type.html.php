			...
			for ($i=0, $n=count($rows); $i < $n; $i++) {
				...
				<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->parent_id; ?>" item-id="<?php echo $row->id ?>" parents="<?php echo $parentsStr ?>" level="0">
					...
					<td align="center" style="text-align:center;"> 
						...
						if($row->type_icon == ""){
							?>
							<img src="<?php echo JUri::root()?>media/com_osproperty/assets/images/googlemapicons/1.png" />
							<?php 
						}else{
							?>
							<img src="<?php echo JUri::root()?>media/com_osproperty/assets/images/googlemapicons/<?php echo $row->type_icon;?>" />
							<?php 
						}
						?>
					</td>
				...
				<tr>
					...
					<td>
						...
						for($i=1;$i<=20;$i++){
							...
							<img src="<?php echo JUri::root()?>media/com_osproperty/assets/images/googlemapicons/<?php echo $i?>.png" />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<?php 
							if($k == 10){
								echo "<BR /><BR />";
