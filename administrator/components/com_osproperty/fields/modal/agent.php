 ...
 * @since  2.8.5
 */
class JFormFieldModal_Agent extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$script[] = '	function jSelectUser_agent_id(id, title, catid, object) {';
		...
		$html	= array();
		$link	= 'index.php?option=com_osproperty&amp;task=agent_list&amp;layout=modal&amp;tmpl=component&amp;function=jSelectUser_agent_id';
		...
		$html[] = '<a href="#modalProperty' . $this->id . '" class="btn hasTooltip" role="button"  data-toggle="modal" title="'
			. JHtml::tooltipText('OS_SELECT_AGENT') . '">'
