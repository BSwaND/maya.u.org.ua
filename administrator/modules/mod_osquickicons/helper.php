        ...
        <div class="icon-wrapper">
            <div class="icon">
                <a href="<?php echo $link; ?>" >
                    <img src="<?php echo JUri::root()?>media/com_osproperty/assets/images/<?php echo $image?>" title="<?php echo $text?>" id="img_div_<?php echo $id_image?>" />
                ...
                <script language="javascript">
                    jQuery("#div_<?php echo $id_image?>").mouseover(function() {
                        jQuery( "#img_div_<?php echo $id_image?>" ).attr("src","<?php echo JUri::root()?>media/com_osproperty/assets/images/<?php echo $image_hover;?>");
                    });
                    jQuery("#div_<?php echo $id_image?>").mouseout(function() {
                        jQuery( "#img_div_<?php echo $id_image?>" ).attr("src","<?php echo JUri::root()?>media/com_osproperty/assets/images/<?php echo $image;?>");
                    });
                </script>
            </div>
        </div>
